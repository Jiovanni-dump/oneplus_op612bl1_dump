...
config_dcc_ddr()
{
    ...
    echo 0x24076D00 1  > $DCC_PATH/config
    echo 0x24076D0C 1  > $DCC_PATH/config
    echo 0x24076D18 1  > $DCC_PATH/config
    echo 0x24076D24 1  > $DCC_PATH/config
    echo 0x24076D30 1  > $DCC_PATH/config
    echo 0x24076D3c 1  > $DCC_PATH/config
    echo 0x24076D48 1  > $DCC_PATH/config
    echo 0x24076D54 1  > $DCC_PATH/config
    echo 0x24076D60 1  > $DCC_PATH/config
    echo 0x24076D6c 1  > $DCC_PATH/config
    echo 0x24076D78 1  > $DCC_PATH/config
    echo 0x24076D84 1  > $DCC_PATH/config
    echo 0x24076D90 1  > $DCC_PATH/config
    echo 0x24076D9C 1  > $DCC_PATH/config
    echo 0x24076DA8 1  > $DCC_PATH/config
    echo 0x24076DB4 1  > $DCC_PATH/config
    echo 0x24076DC0 1  > $DCC_PATH/config
    echo 0x24076DCC 1  > $DCC_PATH/config
    echo 0x24076DD8 1  > $DCC_PATH/config
    echo 0x24076DE4 1  > $DCC_PATH/config
    echo 0x24076DF0 1  > $DCC_PATH/config
    echo 0x24076DFC 1  > $DCC_PATH/config
    echo 0x24076E08 1  > $DCC_PATH/config
    echo 0x24076E14 1  > $DCC_PATH/config
    echo 0x24076E20 1  > $DCC_PATH/config
    echo 0x24076E2C 1  > $DCC_PATH/config
    echo 0x24076E38 1  > $DCC_PATH/config
    echo 0x24076E44 1  > $DCC_PATH/config
    echo 0x24076E50 1  > $DCC_PATH/config
    echo 0x24076E5C 1  > $DCC_PATH/config
    echo 0x24076E68 1  > $DCC_PATH/config
    echo 0x24076E74 1  > $DCC_PATH/config
    ...
    echo 0x24080054	1  > $DCC_PATH/config
    echo 0x2408005C	1  > $DCC_PATH/config
    echo 0x240800C0	21 > $DCC_PATH/config
    ...
    echo 0x240801BC	1  > $DCC_PATH/config
    echo 0x2408020C	1  > $DCC_PATH/config
    echo 0x24080214	1  > $DCC_PATH/config
    echo 0x24080224	1  > $DCC_PATH/config
    echo 0x24080230	1  > $DCC_PATH/config
    echo 0x24080254	1  > $DCC_PATH/config
    ...
    echo 0x248433F4	11 > $DCC_PATH/config
    ...
    echo 0x24845330	3 > $DCC_PATH/config
    ...
    echo 0x24847490	8 > $DCC_PATH/config
    echo 0x248474D0	8 > $DCC_PATH/config
    ...
    echo 0x24864064	1  > $DCC_PATH/config
    ...
    echo 0x2486C020	1  > $DCC_PATH/config
    ...
    echo 0x24872440	2 > $DCC_PATH/config
    ...
    echo 0x248A7030	20 > $DCC_PATH/config
    echo 0x248A7084	1  > $DCC_PATH/config
    echo 0x248A7090	5 > $DCC_PATH/config
    echo 0x248A7218	10 > $DCC_PATH/config
    ...
    echo 0x248E0150	4 > $DCC_PATH/config
    ...
    echo 0x248E600C	5 > $DCC_PATH/config
    echo 0x248E700C	5 > $DCC_PATH/config
    ...
    echo 0x24A03450	1  > $DCC_PATH/config
    ...
    echo 0x24A05804	1  > $DCC_PATH/config
    echo 0x24A0590C	1  > $DCC_PATH/config
    echo 0x24A05A14	1  > $DCC_PATH/config
    echo 0x24A05C00	18 > $DCC_PATH/config
    echo 0x24A05C4C	6 > $DCC_PATH/config
    echo 0x24A05C70	18 > $DCC_PATH/config
    echo 0x24A05CEC	4 > $DCC_PATH/config
    echo 0x24A06728	9 > $DCC_PATH/config
    ...
    echo 0x24A09180	2 > $DCC_PATH/config
    echo 0x24A091A0	1  > $DCC_PATH/config
    echo 0x24A091B0	1  > $DCC_PATH/config
    echo 0x24A091C0	2 > $DCC_PATH/config
    ...
    echo 0x24C433F4	11 > $DCC_PATH/config
    ...
    echo 0x24C45330	3 > $DCC_PATH/config
    ...
    echo 0x24C47490	8 > $DCC_PATH/config
    echo 0x24C474D0	8 > $DCC_PATH/config
    ...
    echo 0x24C64000	1  > $DCC_PATH/config
    echo 0x24C6400C	2 > $DCC_PATH/config
    echo 0x24C64020	1  > $DCC_PATH/config
    echo 0x24C64030	1  > $DCC_PATH/config
    echo 0x24C64040	1  > $DCC_PATH/config
    echo 0x24C64064	1  > $DCC_PATH/config
    echo 0x24C650A4	4 > $DCC_PATH/config
    echo 0x24C650B8	4 > $DCC_PATH/config
    ...
    echo 0x24C6C020	1  > $DCC_PATH/config
    ...
    echo 0x24C72440	2 > $DCC_PATH/config
    ...
    echo 0x24C80020	1  > $DCC_PATH/config
    echo 0x24C81054	1  > $DCC_PATH/config
    echo 0x24C82014	3 > $DCC_PATH/config
    echo 0x24C820A0	1  > $DCC_PATH/config
    echo 0x24C820F4	42 > $DCC_PATH/config
    echo 0x24CA600C	4 > $DCC_PATH/config
    ...
    echo 0x24CA7030	20 > $DCC_PATH/config
    echo 0x24CA7084	1  > $DCC_PATH/config
    echo 0x24CA7090	5 > $DCC_PATH/config
    echo 0x24CA7218	10 > $DCC_PATH/config
    echo 0x24CE002C	1  > $DCC_PATH/config
    echo 0x24CE009C	2 > $DCC_PATH/config
    echo 0x24CE00A8	3 > $DCC_PATH/config
    echo 0x24CE00B8	1  > $DCC_PATH/config
    echo 0x24CE00C0	7 > $DCC_PATH/config
    ...
    echo 0x24CE0150	4 > $DCC_PATH/config
    ...
    echo 0x24CE600C	5 > $DCC_PATH/config
    echo 0x24CE700C	5 > $DCC_PATH/config
    ...
    echo 0x24CEA010	3 > $DCC_PATH/config
    echo 0x24CEA020	3 > $DCC_PATH/config
    echo 0x24CEA030	3 > $DCC_PATH/config
    echo 0x24CEA040	3 > $DCC_PATH/config
    echo 0x24CEA050	3 > $DCC_PATH/config
    ...
    echo 0x24E007E0	2 > $DCC_PATH/config
    ...
    echo 0x24E03450	1  > $DCC_PATH/config
    ...
    echo 0x24E05804	1  > $DCC_PATH/config
    echo 0x24E0590C	1  > $DCC_PATH/config
    echo 0x24E05A14	1  > $DCC_PATH/config
    echo 0x24E05C00	18 > $DCC_PATH/config
    echo 0x24E05C4C	6 > $DCC_PATH/config
    echo 0x24E05C70	18 > $DCC_PATH/config
    echo 0x24E05CEC	4 > $DCC_PATH/config
    echo 0x24E06728	9 > $DCC_PATH/config
    echo 0x24E09100	1  > $DCC_PATH/config
    echo 0x24E09110	1  > $DCC_PATH/config
    echo 0x24E09120	1  > $DCC_PATH/config
    echo 0x24E09170	1  > $DCC_PATH/config
    echo 0x24E09180	2 > $DCC_PATH/config
    echo 0x24E091A0	1  > $DCC_PATH/config
    echo 0x24E091B0	1  > $DCC_PATH/config
    echo 0x24E091C0	2 > $DCC_PATH/config
    echo 0x24E091E0	1  > $DCC_PATH/config
    ...
    echo 0x258433F4	11 > $DCC_PATH/config
    ...
    echo 0x25845330	3 > $DCC_PATH/config
    ...
    echo 0x25847490	8 > $DCC_PATH/config
    echo 0x258474D0	8 > $DCC_PATH/config
    ...
    echo 0x25864000	1  > $DCC_PATH/config
    echo 0x2586400C	2 > $DCC_PATH/config
    echo 0x25864020	1  > $DCC_PATH/config
    echo 0x25864030	1  > $DCC_PATH/config
    echo 0x25864040	1  > $DCC_PATH/config
    echo 0x25864064	1  > $DCC_PATH/config
    echo 0x258650A4	4 > $DCC_PATH/config
    echo 0x258650B8	4 > $DCC_PATH/config
    ...
    echo 0x2586C004	1  > $DCC_PATH/config
    echo 0x2586C014	1  > $DCC_PATH/config
    echo 0x2586C020	1  > $DCC_PATH/config
    echo 0x2586C05C	3 > $DCC_PATH/config
    echo 0x2586C088	1  > $DCC_PATH/config
    echo 0x2586C0D0	1  > $DCC_PATH/config
    echo 0x2586C0F0	1  > $DCC_PATH/config
    echo 0x2586C100	1  > $DCC_PATH/config
    echo 0x2586C114	1  > $DCC_PATH/config
    echo 0x2586C134	1  > $DCC_PATH/config
    echo 0x2586C160	2 > $DCC_PATH/config
    echo 0x2586D064	1  > $DCC_PATH/config
    ...
    echo 0x25872440	2 > $DCC_PATH/config
    ...
    echo 0x25880020	1  > $DCC_PATH/config
    echo 0x25881054	1  > $DCC_PATH/config
    echo 0x25882014	3 > $DCC_PATH/config
    echo 0x258820A0	1  > $DCC_PATH/config
    echo 0x258820F4	42 > $DCC_PATH/config
    echo 0x258A600C	4 > $DCC_PATH/config
    ...
    echo 0x258A7030	20 > $DCC_PATH/config
    echo 0x258A7084	1  > $DCC_PATH/config
    echo 0x258A7090	5 > $DCC_PATH/config
    echo 0x258A7218	10 > $DCC_PATH/config
    echo 0x258E002C	1  > $DCC_PATH/config
    echo 0x258E009C	2 > $DCC_PATH/config
    echo 0x258E00A8	3 > $DCC_PATH/config
    echo 0x258E00B8	1  > $DCC_PATH/config
    echo 0x258E00C0	7 > $DCC_PATH/config
    ...
    echo 0x258E0150	4 > $DCC_PATH/config
    ...
    echo 0x258E600C	5 > $DCC_PATH/config
    echo 0x258E700C	5 > $DCC_PATH/config
    ...
    echo 0x258EA010	3 > $DCC_PATH/config
    echo 0x258EA020	3 > $DCC_PATH/config
    echo 0x258EA030	3 > $DCC_PATH/config
    echo 0x258EA040	3 > $DCC_PATH/config
    echo 0x258EA050	3 > $DCC_PATH/config
    ...
    echo 0x25A007E0	2 > $DCC_PATH/config
    ...
    echo 0x25A03450	1  > $DCC_PATH/config
    ...
    echo 0x25A05804	1  > $DCC_PATH/config
    echo 0x25A0590C	1  > $DCC_PATH/config
    echo 0x25A05A14	1  > $DCC_PATH/config
    echo 0x25A05C00	18 > $DCC_PATH/config
    echo 0x25A05C4C	6 > $DCC_PATH/config
    echo 0x25A05C70	18 > $DCC_PATH/config
    echo 0x25A05CEC	4 > $DCC_PATH/config
    echo 0x25A06728	9 > $DCC_PATH/config
    echo 0x25A09100	1  > $DCC_PATH/config
    echo 0x25A09170	1  > $DCC_PATH/config
    echo 0x25A09180	2 > $DCC_PATH/config
    echo 0x25A091A0	1  > $DCC_PATH/config
    echo 0x25A091B0	1  > $DCC_PATH/config
    echo 0x25A091C0	2 > $DCC_PATH/config
    echo 0x25A091E0	1  > $DCC_PATH/config
    ...
    echo 0x25C433F4	11 > $DCC_PATH/config
    ...
    echo 0x25C45330	3 > $DCC_PATH/config
    ...
    echo 0x25C47490	8 > $DCC_PATH/config
    echo 0x25C474D0	8 > $DCC_PATH/config
    ...
    echo 0x25C64000	1  > $DCC_PATH/config
    echo 0x25C6400C	2 > $DCC_PATH/config
    echo 0x25C64020	1  > $DCC_PATH/config
    echo 0x25C64030	1  > $DCC_PATH/config
    echo 0x25C64040	1  > $DCC_PATH/config
    echo 0x25C64064	1  > $DCC_PATH/config
    echo 0x25C650A4	4 > $DCC_PATH/config
    echo 0x25C650B8	4 > $DCC_PATH/config
    ...
    echo 0x25C6C020	1  > $DCC_PATH/config
    ...
    echo 0x25C72440	2 > $DCC_PATH/config
    ...
    echo 0x25C80020	1  > $DCC_PATH/config
    echo 0x25C81054	1  > $DCC_PATH/config
    echo 0x25C82014	3 > $DCC_PATH/config
    echo 0x25C820A0	1  > $DCC_PATH/config
    echo 0x25C820F4	42 > $DCC_PATH/config
    echo 0x25CA600C	4 > $DCC_PATH/config
    ...
    echo 0x25CA7030	20 > $DCC_PATH/config
    echo 0x25CA7084	1  > $DCC_PATH/config
    echo 0x25CA7090	5 > $DCC_PATH/config
    echo 0x25CA7218	10 > $DCC_PATH/config
    echo 0x25CE002C	1  > $DCC_PATH/config
    echo 0x25CE009C	2 > $DCC_PATH/config
    echo 0x25CE00A8	3 > $DCC_PATH/config
    echo 0x25CE00B8	1  > $DCC_PATH/config
    echo 0x25CE00C0	7 > $DCC_PATH/config
    ...
    echo 0x25CE0150	4 > $DCC_PATH/config
    ...
    echo 0x25CE600C	5 > $DCC_PATH/config
    echo 0x25CE700C	5 > $DCC_PATH/config
    ...
    echo 0x25CEA010	3 > $DCC_PATH/config
    echo 0x25CEA020	3 > $DCC_PATH/config
    echo 0x25CEA030	3 > $DCC_PATH/config
    echo 0x25CEA040	3 > $DCC_PATH/config
    echo 0x25CEA050	3 > $DCC_PATH/config
    ...
    echo 0x25E007E0	2 > $DCC_PATH/config
    ...
    echo 0x25E03450	1  > $DCC_PATH/config
    ...
    echo 0x25E05804	1  > $DCC_PATH/config
    echo 0x25E0590C	1  > $DCC_PATH/config
    echo 0x25E05A14	1  > $DCC_PATH/config
    echo 0x25E05C00	18 > $DCC_PATH/config
    echo 0x25E05C4C	6 > $DCC_PATH/config
    echo 0x25E05C70	18 > $DCC_PATH/config
    echo 0x25E05CEC	4 > $DCC_PATH/config
    echo 0x25E06728	9 > $DCC_PATH/config
    echo 0x25E09100	1  > $DCC_PATH/config
    echo 0x25E09170	1  > $DCC_PATH/config
    echo 0x25E09180	2 > $DCC_PATH/config
    echo 0x25E091A0	1  > $DCC_PATH/config
    echo 0x25E091B0	1  > $DCC_PATH/config
    echo 0x25E091C0	2 > $DCC_PATH/config
    echo 0x25E091E0	1  > $DCC_PATH/config
    ...
    echo 0x25E03428 8 > $DCC_PATH/config
    echo 0x25C75050	4 > $DCC_PATH/config
    echo 0x24A03428	8 > $DCC_PATH/config
    echo 0x24E03428	8 > $DCC_PATH/config
    echo 0x25A03428	8 > $DCC_PATH/config
    echo 0x25E03428	8 > $DCC_PATH/config
    echo 0x24875050	4 > $DCC_PATH/config
    echo 0x24C75050	4 > $DCC_PATH/config
    echo 0x25875050	4 > $DCC_PATH/config
