...
if [ -d /proc/sys/walt ]; then
	...
	if [ $rev == "1.0" ] || [ $rev == "1.1" ]; then
		echo 1440000 0 0 0 0 0 0 > /proc/sys/walt/input_boost/input_boost_freq
	else
		echo 1248000 0 0 0 0 0 0 > /proc/sys/walt/input_boost/input_boost_freq
	fi
	...
	echo 960000 > /sys/devices/system/cpu/cpufreq/policy0/walt/rtg_boost_freq
	echo 940800 > /sys/devices/system/cpu/cpufreq/policy1/walt/rtg_boost_freq
	echo 940800 > /sys/devices/system/cpu/cpufreq/policy4/walt/rtg_boost_freq
	echo 883200 > /sys/devices/system/cpu/cpufreq/policy6/walt/rtg_boost_freq

	echo 1286400 > /sys/devices/system/cpu/cpufreq/policy0/walt/hispeed_freq
	echo 1632000 > /sys/devices/system/cpu/cpufreq/policy1/walt/hispeed_freq
	echo 1632000 > /sys/devices/system/cpu/cpufreq/policy4/walt/hispeed_freq
...
echo 633600 > /sys/devices/system/cpu/cpufreq/policy1/walt/scaling_min_freq
echo 480000 > /sys/devices/system/cpu/cpufreq/policy4/walt/scaling_min_freq
echo 614400 > /sys/devices/system/cpu/cpufreq/policy6/walt/scaling_min_freq
